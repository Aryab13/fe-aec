      ...
      <>
        <nav className="bg-white h-20 flex items-center justify-between px-20 py-3 shadow-lg sticky top-0">
            ...
            <div className="flex gap-8">
                <a className="transition ease-in-out delay-100 hover:text-green-600 cursor-pointer" onClick={() => {navigate('/');window.scrollTo(0, 0);}}>Home</a>
                <a className="transition ease-in-out delay-100 hover:text-green-600 cursor-pointer">Live Session</a>
                <a className="transition ease-in-out delay-100 hover:text-green-600 cursor-pointer">Articles</a>
                <a className="transition ease-in-out delay-100 hover:text-green-600 cursor-pointer">Community</a>
            </div>
            <div className="flex gap-8">
