        ...
        <>
            <form class="max-w-sm mx-auto mt-24">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-100 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name..." required/>
                </div>
                <div class="mb-5">
                ...
                <p className="text-right pt-4">Already have an account? <a onClick={() => {navigate('/login');window.scrollTo(0, 0);}} className="text-green-600 hover:underline cursor-pointer">Login</a></p>
            </form>
        </>
    )
}
