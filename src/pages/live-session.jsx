...
function LiveSession() {
  ...
  return (
    ...
    <div className="p-10 items-center justify-center">
        ...
        <p className="text-xl text-gray-500 my-5 px-40 text-center">A session in which the performance are broadcast or recorded in real time about farming</p>
        <div className="grid grid-cols-4 gap-6">
            {
                data && data.map((item,index) => (
                    <div>
                        <div className="h-[525px] border relative border-gray-200 rounded-lg shadow shadow-xl" key={index}>   
